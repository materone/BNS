...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
	//if autorelease the tableview will crash !!!
	//LoginController *loginController = [[[LoginController alloc] initWithNibName:nil bundle:nil] autorelease];
	LoginController *loginController = [[LoginController alloc] initWithNibName:nil bundle:nil];
	
	CGRect bounds = [[UIScreen mainScreen]bounds];
	self.window = [[UIWindow alloc]initWithFrame:bounds];
	
	loginController.view.frame = window.screen.applicationFrame;
